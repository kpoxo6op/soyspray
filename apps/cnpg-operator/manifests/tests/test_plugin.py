...
APPLICATION = REPOSITORY / "argocd/catalog/cnpg-operator.yaml"
...
class BarmanPluginTests(unittest.TestCase):
    ...
    def test_operator_application_keeps_helm_and_adds_git_plugin_source(self):
        ...
        self.assertEqual(
            application["metadata"]["annotations"]["argocd.argoproj.io/compare-options"],
            "ServerSideDiff=true",
        )
    ...
    def test_render_pins_controller_and_sidecar_images_and_contains_only_objectstores(self):
        ...
        protected = [
            ...
            if item["kind"] in {"CustomResourceDefinition", "ObjectStore"}
        ]
