#!/usr/bin/env python3
"""Train a private GI wake model from one recording of repeated GI speech."""
...
def main() -> int:
    ...
    parser.add_argument("--model-name", default="gi-personalized")
    parser.add_argument("--output-prefix", default="gi-candidate")
