...
.PARAMETER PiHoleIP
The IP address of the Pi-hole DNS server. Defaults to "192.168.1.33".

.EXAMPLE
Switch-DNS
Switches the DNS to the Pi-hole server (192.168.1.33) or back to the default.

.EXAMPLE
Switch-DNS -PiHoleIP "192.168.1.20"
Switches the DNS to a custom Pi-hole server (192.168.1.20) or back to the default.
...
Target DNS:  192.168.1.33 (Pi-hole)
