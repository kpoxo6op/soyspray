...
def test_prometheus_preview_changes_only_the_git_revision():
    task = load_yaml("roles/apps/prometheus/tasks/main.yml")[-1]
    baseline = load_yaml(
    ...
    for revision in (None, "codex/storage-check", "true", "2026"):
        ...
        if revision is not None:
            variables["prometheus_target_revision"] = revision
