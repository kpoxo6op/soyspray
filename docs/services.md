...
| DeepSeek Harness Remote | Private phone access to the official DeepSeek Harness running on laptop `mox`; the existing `opencode.soyspray.vip` hostname is retained | [Application folder](https://github.com/kpoxo6op/soyspray/tree/main/apps/opencode-remote) |
